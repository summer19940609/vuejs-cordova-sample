    ...
    <v-container class="setting-container">
        ...
        <van-form @submit="onSubmit" class="login-form" v-show="formShow">
            ...
            <div style="margin: 16px 0;">
                <van-button block type="info" native-type="submit" class="login-next">下一步</van-button>
            </div>
        </van-form>
